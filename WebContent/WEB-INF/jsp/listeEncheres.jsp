						...
						<div class="col-md-6">
							<div class="card flex-md-row mb-4 box-shadow h-md-250">
								<div class="card-body d-flex flex-column align-items-start">
									<a href="detailVente?vente=${vente.noVente}"> <strong
										class="d-inline-block mb-2 text-primary">${vente.nomArticle}</strong>
									</a>
									...
									<p>
										Vendeur : <a
											href="detailVendeur?pseudo=${vente.vendeur.pseudo}">${vente.vendeur.pseudo}</a>
									</p>
								</div>
