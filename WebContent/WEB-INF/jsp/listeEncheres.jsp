					...
					<c:forEach items="${toutesVentes}" var="vente">
						<div class="col-sm-12 col-md-12 col-lg-6">
							...
							<div class="card flex-md-row mb-4 col-sm-12 col-md-12">
								<img class="card-img-left flex-auto mt-4 mb-4 col-sm-12 col-md-6 col-lg-5 thumbnail" alt="image" src="upload/${vente.image}">
								<%--
								...
								<div class="card-body col-sm-12 col-md-6 col-lg-7">
									...
									<div class="row cardbottom">Fin de l'enchère : ${vente.dateFinEnchere}</div>
									<div class="row">
										Retrait : ${vente.retrait.rue}
									</div>
									<div class="row alignCP">
										${vente.retrait.codePostal} ${vente.retrait.ville}
									</div>
									<div class="row cardbottom">Prix : ${vente.prixVente}</div>
									<div class="row cardbottom">
										Vendeur :
